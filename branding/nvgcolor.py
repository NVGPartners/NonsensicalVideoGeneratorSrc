...
def gradient_box(width, height, color_tl, color_tr, color_bl, color_br, output_file):
...
if __name__ == '__main__':
    ...
    output_file = 'gradient_box.png'

    gradient_box(width, height, color_tl, color_tr, color_bl, color_br, output_file)
