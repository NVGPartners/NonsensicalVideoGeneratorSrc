...
function StartGeneration(options, pluginSettings, functions)
    ...
    if forwardNormal then
        ...
        functions.runFFmpeg("-i \"" .. options.inputVideo .. "\" -vf reverse -af \"areverse,aresample=async=1000\" -vcodec libx264 -crf 28 -preset ultrafast -ac 2 -c:a aac -b:a 160k -reset_timestamps 1 -shortest -fflags +genpts -y \"" .. options.outputVideo .. "\"")
    else
